...
const fs = require('fs')
const lib = fs.readFileSync('D:/coding/dsh-plugin/plugins/dsh-termfleet/lib/index.js', 'utf8')
const header = `/**
...
`
fs.writeFileSync('D:/coding/dsh-plugin/plugins/dsh-termfleet/src/index.ts', header + lib)
console.log('src rebuilt from lib:', (header + lib).length, 'bytes')
